...
3. **§3.1 i18n quality gate** — Script or CI check for missing `ru`/`en` keys; purge remaining stray literals outside localized surfaces.
...
If you must pick **one** next milestone: **§3.1 i18n quality gate (3)** for release hygiene, or **Pilot readiness (4)** if you are moving straight into controlled internal rollout.
